...
public class HomePageTests {
    ...
    public void testHomePageHeaderIsDisplayed() {
        loginPage.loginIntoApp("shireffn369+f@gmail.com", "Shireff@123").assertHomePageHeaderDisplayed();
    }
    ...
    public void testCategorySelection(String category, boolean hasProducts) throws InterruptedException {
        loginPage
                .loginIntoApp("shireffn369+f@gmail.com", "Shireff@123")
                .selectCategory(category)
                .validateProductVisibility(hasProducts, "Category filter failed for: " + category);
    }
    ...
    public void testBrandSelection(String brand, boolean hasProducts) {
        loginPage
                .loginIntoApp("shireffn369+f@gmail.com", "Shireff@123")
                .selectBrand(brand)
                .validateProductVisibility(hasProducts, "Brand filter failed for: " + brand);
    }
    ...
    @Test(priority = 4)
    public void testFeatureProductsInteraction() {
        loginPage
                .loginIntoApp("shireffn369+f@gmail.com", "Shireff@123")
                .assertFeatureProductsDisplayed()
                .clickFirstFeaturedProduct()
                .assertProductModalDisplayed();
    }
    ...
    public void testCustomerReviewsVisibility() {
        loginPage
                .loginIntoApp("shireffn369+f@gmail.com", "Shireff@123")
                .assertCustomerReviewsDisplayed();
    }
